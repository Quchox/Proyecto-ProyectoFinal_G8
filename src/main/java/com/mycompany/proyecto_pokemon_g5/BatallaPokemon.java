...
public class BatallaPokemon extends javax.swing.JFrame {
    ...
    //Temporizador
    private Timer timer;
    private pantallaTorneo pantalla; // Referencia a la clase pantallaTorneo
    
    private int rondaActual = 1;
    private int RondaActual = rondaActual;
    ...
    pantallaTorneo pantalla = new pantallaTorneo();
    pantalla.iniciarTorneo();
    pantalla.setVisible(true);

    // Si deseas ocultar la ventana actual cuando se muestra pantallaTorneo, puedes hacerlo así:
    ...
    public void verificarEstadoDelJuego() {
        RondaActual = rondaActual; // Asegúrate de que RondaActual siempre esté actualizada

        if (listaJugador.cabeza == null) {
            ...
            if (RondaActual < 4) {
                ...
                JOptionPane.showMessageDialog(this, "¡Has ganado! Pasaste a la ronda " + RondaActual + ".", "Siguiente Ronda", JOptionPane.INFORMATION_MESSAGE);
                reiniciarBatalla(); // Llama al método para reiniciar la batalla
            } else {
                JOptionPane.showMessageDialog(this, "¡Felicidades, ganaste el torneo! Eres el Maestro Pokémon.", "Campeón", JOptionPane.INFORMATION_MESSAGE);
                System.exit(0); // Cierra la aplicación
            }
        }
    }
    ...
    // Por ejemplo, reiniciar listas de jugadores y CPU, reiniciar variables, etc.

    // Abre una nueva ventana de BatallaPokemon
    ...
    public javax.swing.JButton botonInicioBatalla;
